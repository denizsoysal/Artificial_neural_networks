...
title("Confusion matrix of stacked-autoencoder before fine-tunning (layers size = [100,50])")
...
figure;
plotconfusion(tTest,y);
title("Confusion matrix of stacked-autoencoder after fine-tunning (layers size = [100,50])")
...
net = patternnet([200 100]);
net=train(net,xTrain,tTrain);
y=net(xTest);
figure;
plotconfusion(tTest,y);
title("Confusion matrix of MLP with hidden layers [100,50]")
