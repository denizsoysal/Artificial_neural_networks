%A script to test if 2d Hopfield network can recognize written numbers
...
imshow(digit)
if i == 1
    title('Noisy digits',FontSize=28)
end
hold on
end
...
imshow(digit)
if i == 1
    title('Reconstructed noisy digits',FontSize=28)
end
hold on
end
